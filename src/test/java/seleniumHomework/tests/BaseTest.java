...
import seleniumHomework.browserFactory.BrowserFactory;
import seleniumHomework.enums.BrowserType;
...
public class BaseTest {
    ...
    protected LandingPage loginToApp(String Username, String Password) throws Exception {
        var landingPage = new LandingPage(driver);
        landingPage.open();
        var loginPage = landingPage.openLoginPage();
        return loginPage.loginManualInput("prostotest", "prostotest");
    }
}